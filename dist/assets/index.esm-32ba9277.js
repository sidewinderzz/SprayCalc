import{L as pm,E as ae,F as _m,w as aa,x as Wl,v as gs,R as ym,t as It,e as Hl,m as Im,T as Tm,j as Em,g as wm,U as Am,V as vm,M as ui,W as Jl,X as Xl,i as Rm,I as Pm,r as Ec,S as Vm}from"./index.esm-87703e00.js";var wc=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ke=new pm("@firebase/firestore");function Nn(){return ke.logLevel}function Dy(r){ke.setLogLevel(r)}function C(r,...t){if(ke.logLevel<=ae.DEBUG){const e=t.map(ua);ke.debug(`Firestore (${ar}): ${r}`,...e)}}function mt(r,...t){if(ke.logLevel<=ae.ERROR){const e=t.map(ua);ke.error(`Firestore (${ar}): ${r}`,...e)}}function Gt(r,...t){if(ke.logLevel<=ae.WARN){const e=t.map(ua);ke.warn(`Firestore (${ar}): ${r}`,...e)}}function ua(r){if(typeof r=="string")return r;try{return function(e){return JSON.stringify(e)}(r)}catch{return r}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const P={OK:"ok",CANCELLED:"cancelled",UNKNOWN:"unknown",INVALID_ARGUMENT:"invalid-argument",DEADLINE_EXCEEDED:"deadline-exceeded",NOT_FOUND:"not-found",ALREADY_EXISTS:"already-exists",PERMISSION_DENIED:"permission-denied",UNAUTHENTICATED:"unauthenticated",RESOURCE_EXHAUSTED:"resource-exhausted",FAILED_PRECONDITION:"failed-precondition",ABORTED:"aborted",OUT_OF_RANGE:"out-of-range",UNIMPLEMENTED:"unimplemented",INTERNAL:"internal",UNAVAILABLE:"unavailable",DATA_LOSS:"data-loss"};class b extends _m{constructor(t,e){super(t,e),this.code=t,this.message=e,this.toString=()=>`${this.name}: [code=${this.code}]: ${this.message}`}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Mg=new st(k.comparator);function Lt(){return Mg}const Jh=new st(k.comparator);function zr(...r){let t=Jh;for(const e of r)t=t.insert(e.key,e);return t}function Xh(r){let t=Jh;return r.forEach((e,n)=>t=t.insert(e,n.overlayedDocument)),t}function Zt(){return Xr()}function Yh(){return Xr()}function Xr(){return new fe(r=>r.toString(),(r,t)=>r.isEqual(t))}const Og=new st(k.comparator),Lg=new et(k.comparator);function G(...r){let t=Lg;for(const e of r)t=t.add(e);return t}const qg=new et(z);function Ea(){return qg}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Fi{constructor(){this._=void 0}}function Bg(r,t,e){return r instanceof Xn?function(s,i){const a={fields:{[bh]:{stringValue:Sh},[Dh]:{timestampValue:{seconds:s.seconds,nanos:s.nanoseconds}}}};return i&&Ci(i)&&(i=Di(i)),i&&(a.fields[Ch]=i),{mapValue:a}}(e,t):r instanceof fn?td(r,t):r instanceof mn?ed(r,t):r instanceof gn?function(s,i){const a=Zh(s,i),u=gi(a)+gi(s.Ae);return us(a)&&us(s.Ae)?wa(u):Ni(s.serializer,u)}(r,t):r instanceof Yn?function(s,i){return Gc(s,i,Math.min)}(r,t):r instanceof Zn?function(s,i){return Gc(s,i,Math.max)}(r,t):void 0}function Ug(r,t,e){return r instanceof fn?td(r,t):r instanceof mn?ed(r,t):e}function Zh(r,t){return r instanceof gn?Nh(t)?t:{integerValue:0}:null}class Xn extends Fi{}class fn extends Fi{constructor(t){super(),this.elements=t}}function td(r,t){const e=nd(t);for(const n of r.elements)e.some(s=>ie(s,n))||e.push(n);return{arrayValue:{values:e}}}class mn extends Fi{constructor(t){super(),this.elements=t}}function ed(r,t){let e=nd(t);for(const n of r.elements)e=e.filter(s=>!ie(s,n));return{arrayValue:{values:e}}}class Aa extends Fi{constructor(t,e){super(),this.serializer=t,this.Ae=e}}class gn extends Aa{}class Yn extends Aa{}class Zn extends Aa{}function Gc(r,t,e){if(!Nh(t))return r.Ae;const n=e(gi(t),gi(r.Ae));return us(t)&&us(r.Ae)?wa(n):Ni(r.serializer,n)}function gi(r){return ut(r.integerValue||r.doubleValue)}function nd(r){return cs(r)&&r.arrayValue.values?r.arrayValue.values.slice():[]}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
