    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="space-y-4">
          <div>
            <h3 className="font-bold text-base mb-2" style={{ color: colors.primary }}>Getting Started</h3>
          ...
          <div>
            <h3 className="font-bold text-base mb-2" style={{ color: colors.primary }}>Smart Features</h3>
            <div className="space-y-2 text-sm" style={{ color: colors.lightText }}>
        ...
        <div className="space-y-4">
          <div>
            <h3 className="font-bold text-base mb-2" style={{ color: colors.primary }}>Key Features</h3>
            <div className="space-y-2 text-sm" style={{ color: colors.lightText }}>
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm" style={{ color: colors.lightText }}>
          <div>
            <h4 className="font-semibold mb-2" style={{ color: colors.primaryDark }}>Small Field (5 acres):</h4>
            <p>• 10 GPA rate = 50 gallons total needed</p>
            <p>• Suggestion: Use 50-gallon fill (1 mix)</p>
            <p>• Perfect — no waste, no partial mix</p>
          </div>
          <div>
            <h4 className="font-semibold mb-2" style={{ color: colors.primaryDark }}>Large Field (45 acres):</h4>
